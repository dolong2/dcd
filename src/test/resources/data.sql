...
create table global_env_entity (id binary(16), env_key varchar(255) not null, env_value varchar(255), workspace_id binary(16) not null, encryption bit(1), primary key (id));
